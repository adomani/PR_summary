...
printf $'<details>
  <summary>You can run this locally by cloning <a href="https://github.com/adomani/PR_summary">adomani/PR_summary</a> and then using `scripts/declarations_diff.sh`.</summary>\n\n
```bash
