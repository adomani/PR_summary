...
printf $'<details>
  <summary>You can run this locally by cloning the  <a href="https://github.com/adomani/PR_summary">adomani/PR_summary</a> repo and then using \'scripts/declarations_diff.sh\' as follows</summary>\n\n
```bash
