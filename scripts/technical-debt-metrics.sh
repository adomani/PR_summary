...
# `./scripts/technical-debt-metrics.sh` returns a tally of some technical debts in the repo,
# reporting also the change with respect to the same counts in the repo from last week.
...
# <number>|description
# ...
# summarizing technical debts in the repo.
...
baseURL='https://github.com/adomani/Mathlib/commit'
